...
$tabTroops = GUICtrlCreateTabItem(GetTranslated(1,1, "Troops"))
	...
	$grpSpells = GUICtrlCreateGroup(GetTranslated(1,54, "Spells"), $x - 20, $y - 20, 145, 185)
		...
		$y = 345
		$grpDark = GUICtrlCreateGroup(GetTranslated(1,54, "Spells"), $x - 20, $y - 20, 145, 185)
		...
		$y +=75
		$lblTotal = GUICtrlCreateLabel(GetTranslated(1,61, "Spells Capacity") & ":", $x - 20 , $y -1, -1, -1, $SS_RIGHT)
 	...
 	GUICtrlCreateGroup("", -99, -99, 1, 1)
		...
		$y +=25
		$btnDark = GUICtrlCreateButton("Normal Spell", $x - 10, $y - 10, 90, 20)
			IF $btnColor then GUICtrlSetBkColor(-1, 0x5CAD85)
			GUICtrlSetOnEvent($btnDark, "hideNormal")
			GUICtrlSetState($btnDark, $GUI_HIDE)
		$btnNormal = GUICtrlCreateButton("Dark Spell", $x - 10, $y - 10, 90, 20)
			IF $btnColor then GUICtrlSetBkColor(-1, 0xDB4D4D)
			GUICtrlSetOnEvent($btnNormal, "hideDark")
