...
; Modified ......: DkEd, Hervidero (2015),lakereng (2016)
...
$tabSearch = GUICtrlCreateTabItem(GetTranslated(2,1, "Search"))
	Local $x = 30, $y = 150
	$grpSearchMode = GUICtrlCreateGroup(GetTranslated(2,57,"Search Mode"), $x - 20, $y - 20, 160, 55) ;search mode
	...
	Local $x = 380, $y = 150
		...
		$btnHeroSwitch = GUICtrlCreateButton("Normal Filters", $x - 15, $y - 5, 90, 35)
			...
			GUICtrlSetOnEvent($btnHeroSwitch, "hidenormalsearch")
